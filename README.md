...
- **Generate Messages:** The app will display random greeting messages.
...
```
  git clone https://github.com/belalgamal46/hello-react-front-end.git
```
...
- [ ] **Add custom messages:** The user can add thier own custom greeting messages
...
Feel free to check the [issues page](https://github.com/belalgamal46/hello-react-front-end/issues).
